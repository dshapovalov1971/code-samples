...
var keyValues = [
  [ 'e-approvers-list', 'application/json', '[{"a": "Designer","l": "approvers-list1@mailinator.com"},{"a": "PAT","l": "approvers-list2@mailinator.com"}]' ]
  ...
  [ 'access-item-text', 'application/json', '[{"a": "Designer","l": "designer tool"},{"a": "PAT","l": "protected information"},{"a": "_","l": "our Online Account"}]' ]
...
resource logicAppOffice365Connector 'Microsoft.Web/connections@2016-06-01' = {
  name: '${resourcePrefix}-APIC-${env}-timkenengineeringhelp-timken.com'
  location: location
  properties: {
    api: {
  ...
  properties: {
    ...
    definition: {
      ...
      actions: {
        ...
        CIAM_Event_Workflow_Outcome: {
          inputs: {
            body: {
              ...
              ProcessedBy: '@{variables(\'approver_email_id\')}'
                    ...
                    inputs: {
                      body: {
                        Message: {
                          ...
                          Subject: '@{if(equals(iterationIndexes(\'Approval_emails\'), 0), \'\', \'REMINDER: \')}@{concat(if(variables(\'registration\'), \'New Timken.com Registration Request Created: \', \'Timken.com Additional Access Requested: \'), join(body(\'New_access_filter\'), \',\'))} {{env-subject}}'
        ...
        Initialize_approver_email_id_variable: {
          inputs: {
            variables: [
              {
            ...
            If_need_to_assign_organization_member: {
              actions: {
                Assign_organization_member: {
                  inputs: {
                    body: 'apiKey=@{triggerBody()?[\'apiKey\']}&userKey=@{encodeUriComponent(body(\'Get_CDC_app_key\')?[\'value\'])}&secret=@{encodeUriComponent(body(\'Get_CDC_app_secret\')?[\'value\'])}&httpStatusCodes=true&UID=@{variables(\'record\')[\'uid\']}&bpid=@{variables(\'record\')[\'bpid\']}&job=@{encodeUriComponent(variables(\'record\')[\'role\'])}&status=active&roleNames=@{encodeUriComponent(if(and(greaterOrEquals(indexOf(variables(\'record\')[\'accessRequest\'], \'Designer\'), 0), less(indexOf(variables(\'record\')[\'accessRequest\'], \'PAT\'), 0)), concat(variables(\'record\')[\'accessRequest\'], \',P&A\'), variables(\'record\')[\'accessRequest\']))}'
                    headers: {
        ...
        Is_there_approver_email: {
          actions: {
            ...
            Set_approver_email_id: {
              inputs: {
                name: 'approver_email_id'
                value: '@body(\'Get_O365_user_profile\')?[\'mail\']'
              }
              runAfter: {
                Get_O365_user_profile: [
                  'Succeeded'
            ...
            actions: {
              Set_approver_email_id_1: {
                inputs: {
                  name: 'approver_email_id'
                  value: '@body(\'Send_approval_email\')?[\'UserEmailAddress\']'
                }
                runAfter: {}
                type: 'SetVariable'
              }
            ...
            and: [
              {
                not: {
                  equals: [
                    '@body(\'Send_approval_email\')?[\'UserEmailAddress\']'
                    null
                  ]
                }
              }
              {
                equals: [
                  '@body(\'Send_approval_email\')?[\'UserId\']'
                  '@body(\'Send_approval_email\')?[\'UserEmailAddress\']'
                ]
              }
            ]
            ...
            or: [
              ...
              }
              {
                and: [
                  ...
                  {
                    equals: [
                      '@triggerBody()?[\'data\']?[\'params\']?[\'preferences\']?[\'privacy\']?[\'privacyTimken\']?[\'isConsentGranted\']'
                      null
                    ]
                  }
                ]
    ...
    parameters: {
      '$connections': {
        value: {
          ...
          office365users: {
            connectionId: logicAppOffice365UsersConnector.id
            connectionName: logicAppOffice365UsersConnector.name
            id: logicAppOffice365UsersConnector.properties.api.id
          }
        }
      }
    }
